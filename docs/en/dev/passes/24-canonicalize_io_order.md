...
- [`LowerPipelineLoops`](23-lower_pipeline_loops.md) — upstream producer of replicated regions that benefit from this pass; leaves `ForKind::Pipeline` as the scope marker this pass consumes
- [`MaterializeTensorStrides`](25-materialize_tensor_strides.md) — registered for the slot immediately after this pass (RFC #1300 P3); fills empty TensorView strides before codegen-prep
- [`MemoryReuse`](27-memory_reuse.md) — runs after this pass; benefits from the co-live tiles in replicated regions
